...
from .forms import StudentRegistrationForm, RoomApplicationForm, ComplaintForm, ComplaintStatusUpdateForm, ComplaintFeedbackForm
...
def submit_complaint(request):
    ...
    return render(request, 'hostel/submit_complaint.html', {
        'form': form,
        'allotment': allotment
    })
...
def complaint_feedback(request, complaint_id):
    ...
    return render(request, 'hostel/complaint_feedback.html', {
        'complaint': complaint,
        'form': form
    })
...
def update_complaint(request, complaint_id):
    ...
    return render(request, 'hostel/update_complaint.html', {
        'complaint': complaint,
        'form': form
    })
...
def analytics_dashboard(request):
    ...
    block_occupied = [
        b.rooms.aggregate(total=Sum('occupied_beds'))['total'] or 0
        for b in blocks
    ]

    block_capacity = [
        b.rooms.aggregate(total=Sum('capacity'))['total'] or 0
        for b in blocks
    ]
